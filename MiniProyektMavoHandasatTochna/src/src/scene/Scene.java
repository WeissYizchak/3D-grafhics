...
public class Scene {
	...
	/**
	 * Adds geometries object to the scene
	 * 
	 * @param g
	 *            - The geometric shape to add
	 */
	public void setGeometries(Geometries g) {
		for(Geometry geometry: g.getGeometries()) {
			_geometries.add(geometry);
		}
	}
	...
	/**
	 * adds a light list to the scene
	 * 
	 * @param lightSource
	 *            -Object inherited from lightSource to add
	 */
	public void addLight(List<LightSource> lightSource) {
		for(LightSource light: lightSource )
			_lights.add(light);
	}
